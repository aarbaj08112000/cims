  ...
  <div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="cat-page-header mb-4">
      <div class="cat-page-header-left d-flex align-items-center">
        ...
        <div>
          <h1 class="cat-page-title mb-1">Initiate Sales Return</h1>
          <nav class="cat-breadcrumb">
            <a href="<%$base_url%>">Home</a>
            <i class="ti ti-chevron-right mx-1"></i>
            <a href="<%$base_url%>sales_return_list">Sales Returns</a>
            <i class="ti ti-chevron-right mx-1"></i>
            <span>Initiate</span>
          </nav>
        </div>
            ...
            <div class="row g-3">
              <div class="col-md-3">
                <div class="info-item">
                  ...
                  <span>Customer: <strong id="billCustomer">—</strong></span>
                </div>
              </div>
              <div class="col-md-3">
                <div class="info-item">
