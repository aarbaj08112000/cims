        ...
        <div class="col-md-6">
            <div class="p-3 bg-white border rounded shadow-sm h-100">
                <h6 class="text-uppercase text-muted fw-bold mb-3" style="font-size: 0.75rem; letter-spacing: 1px;">
                    <i class="ti ti-user text-danger me-1"></i> Customer & Bill
                </h6>
                <h6 class="mb-2 fw-bold text-dark"><%$return['customer_name']|default:'Walk-in Customer'%></h6>
                ...
                <tbody>
                    <%foreach from=$items item=item%>
                        <tr>
                            ...
                            <td class="text-end align-middle">₹<%$item['sale_price']|number_format:2%></td>
