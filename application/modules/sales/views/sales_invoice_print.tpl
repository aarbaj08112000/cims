...
<body>
    ...
    <table class="header-table">
        <tr>
            ...
            <td width="40%" style="text-align: right; vertical-align: top;">
                <div class="invoice-title" style="font-size: 32px; font-weight: bold; color: #111827;">INVOICE</div>
            </td>
        </tr>
    </table>
    <br>
    <table class="sub-header">
        <tr>
            <td width="33%" style="padding:10px;">
                ...
                <div class="value text-primary">#<%$sale['bill_no']%></div>
            </td>
            <td width="33%" class="text-center" style="padding:10px;">
                <div class="label">DATE</div>
                <div class="value"><%$sale['sales_date']|date_format:'%d/%m/%Y'%></div>
            </td>
    ...
    <div class="party-box">
        <div class="label text-primary">CUSTOMER INFO</div>
        <%if $sale['customer_name']|default:'' != ''%>
            <div class="value"><%$sale['customer_name']%></div>
            <div style="font-size: 13px; color: #6b7280; margin-top: 3px;"><%$sale['customer_phone_number']%></div>
        <%else%>
            <div class="value"><%$sale['customer_phone_number']|default:'Walk-In Customer'%></div>
        <%/if%>
    </div>
        ...
        <tr>
            <td width="48%" style="vertical-align: top;">
                <div style="border: 1px solid #f3f4f6; padding: 15px; margin-bottom: 15px;">
                    <div class="label text-primary">PAYMENT INFO</div>
                    <div style="margin-bottom: 5px;"><span class="text-muted" style="display:inline-block; width:60px;">Mode:</span> <strong><%$sale['payment_mode']%></strong></div>
                    <div><span class="text-muted" style="display:inline-block; width:60px;">Status:</span> <strong class="text-success"><%$sale['payment_status']|default:'Paid'%></strong></div>
                </div>
            </td>
            <td width="4%"></td>
            <td width="48%" style="vertical-align: top;">
                <div class="summary-box">
                    <table style="width: 100%;  margin-bottom: 10px; padding-bottom: 10px;">
                        <tr >
                        ...
                        <tr>
                            ...
                            <td class="text-end fw-bold" style="color:#ef4444; padding-top:10px;">- ₹<%$sale['discount_amount']|number_format:2%></td>
                        </tr>
                        <%/if%>
                    </table>
                    ...
                    <table style="width: 100%; margin-top: 0px;">
                        <tr>
                            ...
                            <td class="grand-total-val">₹<%$sale['payable_amount']|number_format:2%></td>
                        </tr>
                    </table>
                </div>
            </td>
    ...
    <table class="signature-table">
        <tr>
            <td width="40%" class="text-center">
                ...
                <div style="font-size: 11px; color: #6b7280;">Receiver Signature</div>
            </td>
            <td width="20%"></td>
            <td width="40%" class="text-center">
                <div class="signature-line"></div>
    ...
    <script>
        // Auto print logic for browser printing
        window.addEventListener('load', function() {
            setTimeout(function() {
                window.print();
            }, 500); // slight delay to ensure fonts/images load
        });
        
        // Use standard approach for closing tabs but often blocked by browser unless opened via JS
