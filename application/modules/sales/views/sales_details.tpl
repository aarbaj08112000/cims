  ...
  <div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="cat-page-header mb-4">
      <div class="cat-page-header-left">
        ...
        <div>
          <h1 class="cat-page-title">Sales Details</h1>
    ...
    <div class="row g-3 mb-4">
      <div class="col-lg-3 col-md-6">
        <div class="pd-stat-card">
          ...
          <div>
            <div class="pd-stat-label">Invoice No</div>
            <div class="pd-stat-value text-primary"><%$sale['bill_no']%></div>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-md-6">
      ...
      <div class="col-lg-3 col-md-6">
        <div class="pd-stat-card">
          <div class="pd-stat-icon green" style="background: <%if $sale['payment_mode'] == 'Cash'%>var(--pd-success-light)<%else%>var(--pd-warning-light)<%/if%>; color: <%if $sale['payment_mode'] == 'Cash'%>var(--pd-success)<%else%>var(--pd-warning)<%/if%>;"><i class="ti ti-credit-card"></i></div>
          <div>
            <div class="pd-stat-label">Payment Mode</div>
            <div class="pd-stat-value"><%$sale['payment_mode']%></div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row g-3 mb-4">
      ...
      <div class="col-lg-4 col-md-6">
        <div class="pd-detail-card">
          <div class="pd-detail-header">
            <h6><i class="ti ti-file-description"></i> Sale Information</h6>
          </div>
          <div class="pd-detail-body">
            <div class="pd-info-row">
              <div class="pd-info-icon"><i class="ti ti-calendar"></i></div>
              <div class="pd-info-content">
                <div class="pd-info-label">Sale Date</div>
                <div class="pd-info-value"><%$sale['sales_date']|date_format:'%d %b %Y'%></div>
              </div>
            </div>
            <div class="pd-info-row">
              <div class="pd-info-icon"><i class="ti ti-receipt"></i></div>
              <div class="pd-info-content">
                <div class="pd-info-label">Invoice No</div>
                <div class="pd-info-value"><%$sale['bill_no']%></div>
              </div>
            </div>
            <div class="pd-info-row">
      ...
      <div class="col-lg-4 col-md-6">
        <div class="pd-detail-card">
          <div class="pd-detail-header">
            <h6><i class="ti ti-user"></i> Customer Information</h6>
          </div>
          <div class="pd-detail-body">
            <div class="pd-info-row">
              <div class="pd-info-icon"><i class="ti ti-user-circle"></i></div>
              <div class="pd-info-content">
                <div class="pd-info-label">Customer Name</div>
                <div class="pd-info-value"><%$sale['customer_name']|default:'Walk-in Customer'%></div>
              </div>
            </div>
            <div class="pd-info-row">
              ...
              <div class="pd-info-content">
                ...
                <div class="pd-info-value"><%$sale['customer_phone_number']|default:'N/A'%></div>
              </div>
            </div>
            <div class="pd-info-row">
              <div class="pd-info-icon <%if $sale['payment_mode'] == 'Cash'%>green<%else%>amber<%/if%>"><i class="ti ti-credit-card"></i></div>
              <div class="pd-info-content">
                <div class="pd-info-label">Payment Mode</div>
                <div class="pd-info-value"><%$sale['payment_mode']%></div>
              </div>
            </div>
            <div class="pd-info-row">
              <div class="pd-info-icon green"><i class="ti ti-shield-check"></i></div>
              <div class="pd-info-content">
                <div class="pd-info-label">Payment Status</div>
                <div>
                  <span class="pd-badge pd-badge-success"><span class="pd-badge-dot"></span> <%$sale['payment_status']|default:'Paid'%></span>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="pd-table-wrap mb-4">
      <div class="pd-table-header">
        <h6><i class="ti ti-list-details"></i> Sold Items</h6>
        ...
        <table>
          <thead>
            <tr>
              ...
              <th class="text-end" style="width:140px">Sale Price</th>
